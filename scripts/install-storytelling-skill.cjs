...
async function main() {
  ...
  const skill = {
    name: 'miora-storytelling',
    key: 'miora-storytelling',
    slug: 'miora-storytelling',
    description: 'Narrative Strategy & Story Crafting',
    path: '/tmp/miora/_bmad/cis/workflows/storytelling',
    markdown: '# Miora Storytelling Skill\n\nCraft compelling narratives using proven frameworks.'
  };
