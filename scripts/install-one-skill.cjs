...
async function main() {
  ...
  const skill = {
    ...
    key: 'miora-strategy',
    slug: 'miora-strategy',
    description: 'Business Model Evolution & Ecosystem Mapping',
    path: '/tmp/miora/_bmad/bmm/workflows/0-business-core/business-model-evolution',
    markdown: '# Miora Strategy Skill\n\nProvides access to Business Model Evolution and Ecosystem Mapping workflows.'
  };
