...
async function main() {
  ...
  const skill = {
    name: 'miora-qa-automation',
    key: 'miora-qa-automation',
    slug: 'miora-qa-automation',
    description: 'Automated E2E & API Testing',
    path: '/tmp/miora/_bmad/bmm/workflows/qa-generate-e2e-tests',
    markdown: '# Miora QA Automation Skill\n\nAutomate tests for existing features with standard patterns.'
  };
