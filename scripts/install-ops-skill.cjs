...
async function main() {
  ...
  const skill = {
    name: 'miora-ops-optimization',
    key: 'miora-ops-optimization',
    slug: 'miora-ops-optimization',
    description: 'Process Automation & Resource Metabolism',
    path: '/tmp/miora/_bmad/bmm/workflows/0-business-core/automation-optimization',
    markdown: '# Miora Operations Optimization Skill\n\nIdentify bottlenecks and automate internal workflows for maximum efficiency.'
  };
