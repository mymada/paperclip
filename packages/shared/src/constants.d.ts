...
export declare const PROOF_TIERS: readonly [0, 1, 2, 3];
export type ProofTier = (typeof PROOF_TIERS)[number];
export declare const RBAC_SCOPES: readonly ["finance", "strategic_vision", "source_code", "legal", "hr", "ops", "general"];
...
export declare const COMPANY_LESSON_STATUSES: readonly ["draft", "active", "archived"];
...
export declare const APPROVAL_TYPES: readonly ["hire_agent", "approve_ceo_strategy", "budget_override_required", "peer_review", "llm_judge"];
