...
export const TASK_WORKTREE_DIR = '.paperclip/worktrees/tasks';
export const TERMINAL_WORKTREE_DIR = '.paperclip/worktrees/terminal';

// Metadata directories (separate from git worktrees to avoid uncommitted files)
export const TERMINAL_WORKTREE_METADATA_DIR = '.paperclip/terminal/metadata';
