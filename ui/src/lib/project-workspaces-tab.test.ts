...
function createIssue(overrides: Partial<Issue>): Issue {
  return {
    ...
    proofRequirementTier: overrides.proofRequirementTier ?? null,
    reviewIterationCount: overrides.reviewIterationCount ?? 0,
    resolutionPayload: overrides.resolutionPayload ?? null,
