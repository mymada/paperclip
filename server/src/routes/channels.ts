...
export function channelRoutes(db: Db) {
  ...
  router.get("/companies/:companyId/channel-connections", async (req: Request, res: Response) => {
  ...
  router.delete("/companies/:companyId/channel-connections/:connectionId", async (req: Request, res: Response) => {
    const companyId = req.params.companyId as string;
    const connectionId = req.params.connectionId as string;
    assertCompanyAccess(req, companyId);
  ...
  router.get("/companies/:companyId/channel-sessions", async (req: Request, res: Response) => {
    const companyId = req.params.companyId as string;
    assertCompanyAccess(req, companyId);
  ...
  router.get("/companies/:companyId/channel-pairings", async (req: Request, res: Response) => {
    const companyId = req.params.companyId as string;
    assertCompanyAccess(req, companyId);
